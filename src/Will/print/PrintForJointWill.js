...
function PrintForJointWill({
  ...
  // });
  console.log("Executor1", executorDetails);
    ...
    <div style={{ width: "794px" }} ref={printRef}>
      ...
      >
        ...
        <div style={{ marginTop: "5px" }}>
          <p className="pb-2" style={{ fontSize: "14px" }}>
            ...
            <br />
            <br />
            Thank you for making “Will” at itiseasy.in. We sincerely applaud you
            for taking this step towards securing your loved ones’ interests.
          </p>
        </div>
      </div>
      <div
      ...
      >
        ...
        <p style={{ textAlign: "justify", margin: "auto", marginTop: "30px" }}>
          ...
          (hereinafter the TESTATOR1) son/daughter of{" "}
          <span style={{ textTransform: "capitalize" }}>
          ...
          (hereinafter the TESTATOR2) son/daughter of{" "}
          <span style={{ textTransform: "capitalize" }}>
            {jointWillData.fatherName}
          </span>
          , aged
          <span style={{ textTransform: "capitalize" }}>
            {jointWillData.age}
          ...
          years, Indian inhabitant,{" "}
          <span style={{ textTransform: "capitalize" }}>
            {jointWillData.religion}
          </span>{" "}
          by religion,{" "}
          <span style={{ textTransform: "capitalize" }}>
            {jointWillData.occupation}
          </span>{" "}
          occupation residing at{" "}
          <span style={{ textTransform: "capitalize" }}>
            {jointWillData.address}
          </span>{" "}
          being of sound mind and disposing mind, memory and understanding, out
          of our free volition and without any persuasion or coercion do hereby
          make, publish and declare this to be our last Will and Testament,
          hereby expressly revoking all Wills and Codicils previously made by us
        ...
        <p style={{ textAlign: "justify" }}>
          ...
          our intent to create this last Will and Testament in accordance with
          the rules mandated by the law to avoid any dispute or difference
          regarding our moveable and immovable properties after our death.
        </p>
        <br />
        <p style={{ textAlign: "justify" }}>
          Testator 1{" "}
        ...
        <p style={{ textAlign: "justify" }}>
          ...
          , Mother :{" "}
          <span style={{ textTransform: "capitalize" }}>
            {jointWillData.motherName}
          </span>
          ,
          {siblingData2 && (
            <>
              {siblingData2.siblings.map((s) => {
                return s.type == "Brother" ? (
                  <>
                    {" "}
                    Brother/s: {s.name}, aged{" "}
        ...
        <br />
        {jointWillData.relationWithWillMaker == "Spouse" && childrenData && (
          <p style={{ textAlign: "justify" }}>
        ...
        {firstFormValues.maritalStatus != "Unmarried" &&
          jointWillData.relationWithWillMaker != "Spouse" && (
            <p style={{ textAlign: "justify" }}>
              <span style={{ textTransform: "capitalize" }}>
                Testator 1 ({firstFormValues.name})
              </span>{" "}
              {firstFormValues.maritalStatus == "Married" ? "am" : "was"}{" "}
              married to{" "}
              <span style={{ textTransform: "capitalize" }}>
                ...
                <>
                  {childrenData.childrens.map((s) => {
                    return s.type == "Son" ? (
                      <>
                        {" "}
                        and have the children Son : {s.name}, aged{" "}
                        <span style={{ textTransform: "capitalize" }}>
                          {s.age}
                        </span>{" "}
                        years,{" "}
        ...
        <br />
        {jointWillData.maritalStatus != "Unmarried" &&
          jointWillData.relationWithWillMaker != "Spouse" && (
            <p style={{ textAlign: "justify" }}>
              <span style={{ textTransform: "capitalize" }}>
                Testator 2 ({jointWillData.name})
              </span>{" "}
              {jointWillData.maritalStatus == "Married" ? "am" : "was"} married
              to{" "}
              <span style={{ textTransform: "capitalize" }}>
                {jointWillData.spouseName}
              </span>{" "}
              {childrenData2 && (
                <>
                  {childrenData2.childrens.map((s) => {
                    return s.type == "Son" ? (
                      <>
                        {" "}
                        and have the children Son : {s.name}, aged{" "}
        ...
        {jointWillData.maritalStatus != "Married" && (
          <p style={{ textAlign: "justify" }}>
            {" "}
            <span style={{ textTransform: "capitalize" }}>
              Testator 2 ({firstFormValues.name})
            </span>{" "}
            is not married.
          </p>
        )}
        ...
        <br />
        <p style={{ textAlign: "justify" }}>
          We further wish that after the death of{" "}
          <span style={{ textTransform: "capitalize" }}>
            {firstFormValues.name}
          </span>
          , the body be, {finalPageData && finalPageData.hanleRemains}
        </p>
        <br />
        <p style={{ textAlign: "justify" }}>
          We further wish that after the death of{" "}
          ...
          , the body be, {finalPageData && finalPageData.hanleRemains2}
        </p>
        <br />
        <div className="declaration">
          ...
          <br />
          <p style={{ textAlign: "justify" }}>
            We, the Testators/Testatrix and the witnesses, whose names are
            signed to the foregoing instrument, being first duly sworn, do
            hereby declare to the undersigned authority that the
            Testator/Testatrix signed and executed the instrument as his/her
            Last Will and Testament and that he/she had signed willingly, and
            ...
            presence of the Testator/Testatrix was at the time eighteen (18) or
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            declared by{" "}
            <span style={{ textTransform: "capitalize" }}>
              {firstFormValues.name}, {jointWillData.name}
            </span>
...
export default PrintForJointWill;

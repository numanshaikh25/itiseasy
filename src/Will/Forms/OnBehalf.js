...
const OnBehalf = ({
  ...
  const selfFormSchema = yup.object({
    ...
    reason: yup.string().required("Reason for you making the will is required"),
  });

  const handleSubmit = (vals) => {
    console.log(vals);
    setOnBehalfData(vals);
    if (haveSiblings == "yes") {
            ...
            <form>
              <div className="row">
                <h2 className="mt-2 mb-4">
                  Details of the person for whom I am making this will:
                </h2>
                ...
                <div>
                  <input
                    ...
                    name="reason"
                    type="text"
                    placeholder="Reason for them not operating the site"
                    className="form-control"
                    reason
                    onChange={formikProps.handleChange("reason")}
